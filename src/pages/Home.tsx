  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 
        'Free professional horse calculators for UK equestrians. Calculate livery, farrier, feed, competition & annual costs instantly. Plan your horse business finances with confidence.'
      )
    }
  }, [])
